...
- PENTING: Jika pengguna bertanya siapa yang menyusun, meninjau, menyetujui, mengesahkan, atau membuat suatu dokumen SOP, carilah di halaman sampul/pengesahan dokumen tersebut. Informasi ini biasanya tertera sebagai "Disusun oleh:", "Ditinjau oleh:", "Disetujui Oleh:", atau "Formulir Pengesahan". Nama orang dan divisi yang tercantum di bagian tersebut ADALAH jawaban langsung untuk pertanyaan semacam ini. Juga perhatikan "Alasan:" pada halaman pengesahan yang menjelaskan alasan penerbitan/revisi dokumen.
